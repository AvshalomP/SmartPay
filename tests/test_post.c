...
char buf[BUFSIZE];
const char * expceted_postWithData_json    = "{ \"Response\": { \"terminalID\": 3 } }";      //json response to be returned
const char * expceted_postWithNoData_json  = "{ 'error': [This is a POST request with NO data!] }";   //json response to be returned
